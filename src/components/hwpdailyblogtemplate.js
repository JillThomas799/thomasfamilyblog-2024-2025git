...
<div className="datenewsDivHwp">
            ...
            <ul className="hwpIntroList">
                <li><strong className="titles">Parking:</strong> </li>
                <li><strong className="titles">Distance:</strong> <strong></strong> <strong>Descent:</strong>30 metres, 98 feet. </li>
                <li><strong className="titles">Refreshments:</strong> </li>
                </ul>        
            <strong className="headTitles">Good</strong> 
            <ul className="hwpIntroList">
              <div className="listItemsAlign">
                <li><strong className="titles">Ambience :</strong></li> 
                <li><strong className="titles">Sights: </strong></li> 
                <li><strong className="titles">Information boards:</strong></li>
                <li><strong className="titles">Weather:</strong></li>
                </div>
                </ul>
                <br />
            ...
            </div>  {/* Closing tag for newsHwp div*/ } 
        ...
        </div> {/*</div>Closing tag datenewsDivHwp*/}
        </div>   
