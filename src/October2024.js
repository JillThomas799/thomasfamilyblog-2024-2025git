    ...
    <div>
      <div className="October2024header">
        ...
        <div className="datenewsDivOctober">
          <section className="newsheaderOctober">
            Welcome to our October 2024 blog
          </section>
          <section className="newsOctober" style={{ textAlign: "center" }}>
            Welcome to our October blog. It is now well and truly autumn and so
          ...
          <section className="newsheaderOctober">
            Trip to London on the train to see The Silk Roads Exhibition at the
            British Museum
          </section>
          <section className="newsOctober" style={{ textAlign: "center" }}>
            ...
            <Link
              to="https://www.britishmuseum.org/visit/food-and-drink/great-court-restaurant"
              target="_blank"
          ...
          <div className="SlideshowHostPhotoOctober">
            <Link
              to="https://photos.app.goo.gl/WkF9CqoN6rWGiV87A"
              target="_blank"
              title="Click on the link and read the full comments on each photo to accompany us on our trip to London and the Silk Roads Exhibition."
            >
              <strong>
                <div className="slideshowinstructionsOctober">
                  {" "}
                  Click on the image below to open the photo album of our trip
                ...
                {/*Closing div slideshowinstructionsOctober*/}
                <img
                  className="slideshowentryOctober"
          ...
          <section className="newsOctober" style={{ textAlign: "center" }}>
            A big thank you to all our friends and relatives who have taken the
          ...
          <section className="newsheaderOctober">
            Trip with friends to see REST IS POLITICS LIVE at the O2 Apollo
            Theatre, Manchester
          </section>
          <section className="newsOctober" style={{ textAlign: "center" }}>
            Today it was time for our long awaited trip with friends to see the
          ...
          <section className="newsOctober" style={{ textAlign: "center" }}>
            We woke this morning and went to turn on the shower only to
          ...
          <section className="newsheaderOctober">
            Time for a Lennie update....
          </section>
          <section className="newsOctober" style={{ textAlign: "center" }}>
            We have realised that Lennie has not featured much recently, so we
          ...
          <section className="newsheaderOctober">
            Winter Droving, Penrith, in which Paddington Bear also makes an
            appearance....
          </section>
          <section className="newsOctober" style={{ textAlign: "center" }}>
          ...
          <div className="SlideshowHostPhotoOctober">
            <Link
              to="https://photos.app.goo.gl/WtnnTBECNbttWMoY8"
              target="_blank"
              title="Click on the link and read the full comments on each photo to accompany us on our trip to London and the Silk Roads Exhibition."
            >
              <strong>
        ...
        {/* Closing tag datenewsDivOctober */}
      </div>
    </div>
  );
}
