...
<stop offset="2%" style={{ stopColor:"#FFFDD1", stopOpacity:1}} />       
<stop offset="3%" style={{ stopColor:"#7E4820", stopOpacity:0.8}} />
<stop offset="20%" style={{ stopColor:"#FFFDD1", stopOpacity:1}} />       
<stop offset="21%" style={{ stopColor:"#7E4820", stopOpacity:0.8}} />
<stop offset="41%" style={{ stopColor:"#FFFDD1", stopOpacity:1}} />    
<stop offset="42%" style={{ stopColor:"#7E4820", stopOpacity:0.8}} />
<stop offset="62%" style={{ stopColor:"#FFFDD1", stopOpacity:1}} /> 
<stop offset="63%" style={{ stopColor:"#7E4820", stopOpacity:0.8}} />
<stop offset="83%" style={{ stopColor:"#FFFDD1", stopOpacity:1}} /> 
<stop offset="84%" style={{ stopColor:"#7E4820", stopOpacity:0.8}} />
<stop offset="100%" style={{ stopColor:"#FFFDD1", stopOpacity:1}} /> 
</radialGradient>


<linearGradient id="gradPheasantFeather3" x1="0%" x2="10%" y1="0%" y2="90%">
<stop offset="0%" style={{ stopColor:"#F6E8B1", stopOpacity:1}} />       
<stop offset="20%" style={{ stopColor:"#7E4820", stopOpacity:0.8}} />
<stop offset="30%" style={{ stopColor:"#F6E8B1", stopOpacity:1}} />       
<stop offset="50%" style={{ stopColor:"#7E4820", stopOpacity:0.8}} />
<stop offset="60%" style={{ stopColor:"#F6E8B1", stopOpacity:1}} />    
<stop offset="80%" style={{ stopColor:"##7E4820", stopOpacity:0.8}} />
<stop offset="90%" style={{ stopColor:"#F6E8B1", stopOpacity:1}} /> 
<stop offset="100%" style={{ stopColor:"#7E4820", stopOpacity:0.8}} />
  ...
  <filter id="blur5" x="0" y="0">    
    ...
    <path d = "M 840 365 Q 800 340 760 350 Q 650 430 800 430 Q 885 440 835 365 " fill="url(#gradPheasantFeather2)" opacity="0.6" />
    </g>
    ...
    <g className = "pheasantFeather1">
      <path d = "M 840 365 Q 820 355 780 395 L 710 430 L 800 430 Q 885 440 835 365 " fill="#B87333" opacity="1" />
      <g id="wingMarkers">
    ...
    <g className = "pheasantFeather5">
      <path d="M 770 344 Q 730 355 720 379 L 660 420 L 720 420 L 720 430 L 750 424 L 770 344 " fill="url(#gradPheasantFeather3)" opacity="1" />
    </g>

    <g className = "pheasantFeather4">
      <path d="M 840 364 Q 770 324 760 364 L 785 380 Q 810 380 841 365" fill="#7E4820" opacity="1" />
    </g>
