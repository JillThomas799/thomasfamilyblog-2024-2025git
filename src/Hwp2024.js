...
export default function Hwp2024() {
  return (
    <div className="bodyHwp">
      ...
      <h1
        className="hadrianswallTitle"
        style={{ backgroundColor: "#66023c", borderRadius: "0" }}
      >
        Hadrian's Wall Path 2024
        <Romaneagle />
        <HWPThermometer />
      ...
      <div className="datenewsDivHwp">
        <section className="dateHwp">
          1st June, 2024 onwards.... Hadrian's Wall Long Distance Path{" "}
        </section>
        ...
        <div className="newsHwp">
          <div className="hwpDailyNarrative">
            ...
            <Link
              to="https://www.ncl.ac.uk/press/articles/latest/2024/05/tyrianpurplecarlisle/"
              target="_blank"
          ...
          {/*Closing tab for hwpDailyNarrative div */}
        </div>{" "}
        {/*Closing tab for newsHwp div */}
      </div>{" "}
      {/*Closing tab for datenewsDivHwp div */}
      <div className="datenewsDivHwp">
        <section className="newsheaderHwp">
          <strong>
            Day 1 - Wallsend to Newcastle Swing Bridge: 5.1 miles on the
            Hadrian's Wall Path, 7.5 miles total
          </strong>
        </section>
        ...
        <div className="newsHwp">
          <div className="componentWalkDetails">
            ...
            <ul className="hwpIntroList">
              <li>
                ...
                <Link to="https://www.paybyphone.co.uk/" target="_blank">
                  Pay by Phone
                </Link>{" "}
                app on your mobile phone.
              </li>
              <li>
                <strong className="titles">Public Transport: </strong>
                ...
                <Link
                  to="https://www.nexus.org.uk/ticket-information/pop/pop-app"
                  target="_blank"
              ...
              <li>
                <strong className="titles">Distance:</strong>
              ...
              <li>
                ...
                <br />
                <Link
                  to="https://oswinproject.org.uk/our-work/cafe-16-at-newcastle-cathedral/"
                  target="_blank"
            ...
            <ul className="hwpIntroList">
              <div className="listItemsAlign">
                <li>
                  <strong className="titles">Museums :</strong>
                  <br />
                  <Link
                    to="https://segedunumromanfort.org.uk/"
                    target="_blank"
                    title="Click here
            to discover more about Segedunum Fort"
                  ...
                  ,{" "}
                  <Link
                    to="https://www.newcastlecastle.co.uk/"
                    target="_blank"
                    title="Click 
            here to discover more about Newcastle Castle"
                ...
                <li>
                  <strong className="titles">Walk : </strong>
                  <br />
                ...
                <li>
                  <strong className="titles">History : </strong>
                  <br />
            ...
            <ul className="hwpIntroList">
              <li>
                <strong className="titles">Underfoot</strong>
                <br />
                All of the walk was on firm surfaces.
              </li>
              <li>
                <strong className="titles">Seating</strong>
                <br />
            ...
            <ul className="hwpIntroList">
              <li>
                <strong className="titles">8 (out of 10):</strong> Better walk
          ...
          <div className="hwpDailyNarrative">
            ...
            easily. We used the{" "}
            <Link
              to="https://www.getintonewcastle.co.uk/venues/quayside-multi-storey-car-park"
              target="_blank"
            ...
            as this{" "}
            <Link
              to="https://www.bbc.com/news/articles/cndd2wppy3xo"
              target="_blank"
      ...
      <div className="datenewsDivHwp">
        <section className="newsheaderHwp">
          <strong>
            Day 2 - Newcastle Gateshead millennium Bridge to Tyne Riverside
      ...
      <div className="newsHwp">
        <div className="componentWalkDetails">
          ...
          <ul className="hwpIntroList">
            ...
            <li>
              ...
              <Link
                to="https://www.getintonewcastle.co.uk/venues/starbucks-malmaison"
                target="_blank"
              ...
              <Link
                to="https://www.branzinorestaurant.co.uk/"
                target="_blank"
          ...
          <ul className="hwpIntroList">
            <div className="listItemsAlign">
              <li>
                <strong className="titles">Points of Interest :</strong>
                <br />
              ...
              <li>
                <strong className="titles">Weather:</strong>
                <br /> It was a beautiful, sunny day.
              </li>
            </div>
          </ul>
          <br />
          ...
          <ul className="hwpIntroList">
            <li>
              <strong className="titles">Traffic congestion</strong>
              <br />
          ...
          <ul className="hwpIntroList">
            <li>
              <strong className="titles">8 (out of 10):</strong> This was an
              interesting and enjoyable walk. There was more opportunity to sit
        ...
        <div className="hwpDailyNarrative">
          ...
          <Link
            to="https://www.redbull.com/gb-en/events/red-bull-tyne-ride"
            target="_blank"
            className="LinkHWP"
          >
            {" "}
          ...
          was made by the British Artist Blacksmiths Association and unveiled in
          ...
          <ol>
            <li>
              <strong>Gateshead millennium Bridge :</strong> <br /> was opened
              on September 17th, 2001. It was designed to link Newcastle's north
              bank with Gateshead Quays, the new arts and cultural quarter to
            ...
            <li>
              ...
              opened on 10 October 1928 by King George V, who was first to cross
              it with Queen Mary. It was built of Cornish granite by the
              engineering firm Mott, Hay and Anderson and is today Grade II
              listed and recognised as being a key symbol of Newcastle's
              identity. It was built for the new age of the motorised-vehicle
            ...
            <li>
              ...
              Old Tyne Bridges of 1270 and 1781, and probably of the original
              Roman Pons Aelius bridge, which was both a very important part of
              the Roman infrastructure, but also a site of religious worship as
              revealed by the presence of two altars, dedicated to the water
              gods Neptune and Oceanus, which were found on the site of the
              bridge in the late 19th century. <br /> The new bridge was opened
              in 1876 and is a swinging bridge of electric/hydraulic operation.
              It was necessary to replace the old Georgian Bridge as the old
              bridge was low level and prevented larger vessels from moving up
              river. This meant that keels were needed to transport coal from
              the riverbank staiths at Dunston, Derwenthaugh and beyond to the
              ships further down river, an inefficient and time-consuming
              process. Armstrong's factories at Elswick were held back due to
              the impossibility of ships reaching there. Trade was greatly
              stimulated after the Swing Bridge opened. Armstrong's Elswick
            ...
            <li>
              ...
              intercity train line runs and which was designed by Robert
            ...
            <li>
              ...
              VII Bridge spans the River Tyne between Newcastle upon Tyne and
              Gateshead. This bridge, together with the High Level Bridge
              completed a loop of railway tracks using both sides of the Tyne
              making train movements easier. Trains from north or south of
              Newcastle could enter or leave via the new bridge and the west end
              of Central Station, which now became a through station for
              north-south trains. At the Gateshead end are two viaducts, one
              turning west and one east so that trains can be sent in either
              direction. <br /> Construction began in July 1902 and the bridge
            ...
            <li>
              ...
              <br />
              There have been 3 Redheugh Bridges spanning the River Tyne and
              currently carrying the A189 road. The first Redheugh Bridge, built
              by Thomas Bouch, was opened in 1871. It needed to be replaced
              because of structural faults. The second bridge, built by Sir
              William Arrol & Co, was opened on 13th August 1901. The third and
              current Redheugh Bridge was built by Edmund Nuttall Ltd and opened
              on 18th May 1983 by Princess Diana.
            </li>
            <br />
            <br />
          </ol>
          This additional{" "}
          <Link
            to="https://englandsnortheast.co.uk/newcastle-quayside-history/"
            target="_blank"
      ...
      <div className="datenewsDivHwp">
        <section className="newsheaderHwp">
          <strong>
            Day 3 - Tyne Riverside Country Park to Whittle Dene Reservoirs: 8.6
            miles on the Hadrian's Wall Path, 9.56 miles in total.
          </strong>
        </section>
        ...
        <div className="newsHwp">
          <div className="componentWalkDetails">
            ...
            <ul className="hwpIntroList">
              ...
              <li>
                <strong className="titles">Paths: </strong>
                <br />
              ...
              <li>
                <strong className="titles">Distance:</strong>
                <br /> 9.56 miles in total, of which 8.6 miles on the Hadrian's
              ...
              <li>
                ...
                for{" "}
                <Link
                  to="https://www.spar.co.uk/store-locator/hal22784-spar-heddon"
                  target="_blank"
                  className="LinkHWP"
                >
            ...
            <ul className="hwpIntroList">
              <div className="listItemsAlign">
                <li>
                  <strong className="titles">Heddon-on-the-Wall : </strong> is
                  an interesting and pretty village, situated up on the hill.
                ...
                <li>
                  <strong className="titles">History : </strong> The remains of{" "}
                  <Link
                    to="https://rudchester.org/fort.html"
                    target="_blank"
                ...
                <li>
                  <strong className="titles">Weather:</strong> Whilst cloudy, it
                  was warm and a pleasant day with no rain. <br />
                </li>
              </div>
            </ul>
            <br />
            ...
            <ul className="hwpIntroList">
              <li>
                <strong className="titles">Waymarks initially: </strong>Google
                maps will not take you to the correct place on Tyne Riverside
                ...
                Riverside Coffee Shop. <br /> On leaving the car, walk directly
              ...
              <li>
                <strong className="titles">Refreshments - Lack of:</strong>{" "}
              ...
              <li>
                <strong className="titles"></strong>
                <br />{" "}
              </li>
            </ul>
            <strong className="headTitles">Hike Rating</strong>
            <ul className="hwpIntroList">
              <li>
                <strong className="titles">8 (out of 10):</strong> What can we
          ...
          <br />
          <div className="hwpDailyNarrative">
            We were walking today from Tyne Riverside Country Park, which is
            located 7 miles from the centre of Newcastle, up via
            Heddon-on-the-Wall and over to Whittle dene reservoir. On leaving
            the Tyne Riverside Country Park, we shortly joined the{" "}
            <Link
              to="https://co-curate.ncl.ac.uk/wylam-wagonway/"
              target="_blank"
              className="LinkHWP"
            >
              {" "}
            ...
            <Link
              to="https://www.facebook.com/THREETUNSHEDDON/?_rdr"
              target="_blank"
              className="LinkHWP"
            >
              The Three Tuns
            ...
            and{" "}
            <Link
              to="https://www.vintageinn.co.uk/restaurants/north-east/swan-at-heddon?utm_source=google&utm_medium=organic&utm_campaign=gmb-homepage#/"
              target="_blank"
              className="LinkHWP"
            >
              {" "}
            ...
            <Link
              to="https://www.tripadvisor.co.uk/Restaurant_Review-g1653233-d25194372-Reviews-Bell_E_Buon-Heddon_on_the_Wall_Northumberland_England.html"
              target="_blank"
              className="LinkHWP"
            >
              {" "}
            ...
            <Link
              to="https://www.tripadvisor.co.uk/ShowUserReviews-g1051961-d1508482-r953594113-The_Errington_Coffee_House-Corbridge_Northumberland_England.html"
              target="_blank"
            ...
            <br />
            <br />
            Join us on our 3rd day of the Hadrian's Wall Path by clicking on the
            album below and following our narrative by clicking on the added
            comments.
          </div>{" "}
          {/*Closing tag for hwpDailyNarrative div */}
      ...
      <div className="datenewsDivHwp">
        <section className="newsheaderHwp">
          <strong>
            Day 4 - Whittle Dene Reservoirs to Chollerford with Brunton
            Turret(26a) and Chesters Bridge Abutment: 12.6 miles
          </strong>
        </section>
        ...
        <div className="newsHwp">
          <div className="componentWalkDetails">
            ...
            <ul className="hwpIntroList">
              ...
              <li>
                <strong className="titles">Paths: </strong>Clear, well-marked
              ...
              <li>
                <strong className="titles">Distance:</strong>
                <br /> 12.6 miles in total, of which on the Hadrian's Wall Path.
                <strong> Ascent:</strong> 246 metres, 810 feet.{" "}
              </li>
              <li>
                <strong className="titles">Refreshments:</strong>
                <br />
            ...
            <ul className="hwpIntroList">
              <div className="listItemsAlign">
                ...
                <li>
                  <strong className="titles">Local hospitality: </strong>
                  <br />A big plus for the hospitality of the Robin Hood inn and
            ...
            <ul className="hwpIntroList">
              <li>
                <strong className="titles">Weather: </strong> <br />
                It was unfortunately raining all morning, which was a shame.
              </li>
              <li>
                <strong className="titles">Distance: </strong> <br />
            ...
            <ul className="hwpIntroList">
              <li>
                <strong className="titles">8 (out of 10):</strong>{" "}
              </li>
            </ul>
          </div>{" "}
          {/* Closing tag ComponentWalkDetails Class*/}
          ...
          <div className="hwpDailyNarrative">
            ...
            <Link
              to="https://www.nwt.org.uk/nature-reserves/whittle-dene"
              target="_blank"
            ...
            <Link
              to="https://robinhoodinnhadrianswall.co.uk/"
              target="_blank"
            ...
            <Link
              to="https://www.u3ahadrianswall.co.uk/halton-chesters-roman-fort/"
              target="_blank"
            ...
            ,
            <Link
              to="https://www.roman-britain.co.uk/places/portgate/"
              target="_blank"
              className="LinkHWP"
            >
              {" "}
            ...
            ,{" "}
            <Link
              to="https://fabulousnorth.com/heavenfield/"
              target="_blank"
            ...
            ,{" "}
            <Link
              to="https://www.english-heritage.org.uk/visit/places/planetrees-roman-wall-hadrians-wall/"
              target="_blank"
            ...
            ,{" "}
            <Link
              to="https://www.english-heritage.org.uk/visit/places/brunton-turret-hadrians-wall/"
              target="_blank"
            ...
            , and the{" "}
            <Link
              to="https://www.english-heritage.org.uk/visit/places/chesters-bridge-abutment-hadrians-wall/"
              target="_blank"
            ...
            <Link
              to="https://en.wikipedia.org/wiki/Vallum_(Hadrian%27s_Wall)"
              target="_blank"
            ...
            <br />
            <br />
            We invite you to join us on our 4th day of the Hadrian's Wall Path
      ...
      <div className="datenewsDivHwp">
        <section className="newsheaderHwp">
          <strong>
            Day 5 - Chollerford to Brocolitia/Carrawburgh Roman Fort: 4miles
          </strong>
        </section>
        ...
        <div className="newsHwp">
          <div className="componentWalkDetails">
            ...
            <ul className="hwpIntroList">
              ...
              <li>
                <strong className="titles">Distance:</strong>
                <br /> 4 miles on the Hadrian's Wall Path
                <strong> Ascent:</strong> 215 metres, 705 feet.{" "}
              </li>
              <li>
                <strong className="titles">Refreshments:</strong>
                <br />
            ...
            <ul className="hwpIntroList">
              <div className="listItemsAlign">
                <li>
                  <strong className="titles">Views :</strong>
                  <br />
                ...
                <li>
                  <strong className="titles">Weather: </strong>
                  <br /> Whilst a rather cloudy day, the wind had dropped from
            ...
            <ul className="hwpIntroList">
              <li>
                <strong className="titles">9 (out of 10):</strong>{" "}
              </li>
            </ul>
          </div>{" "}
          {/* Closing tag ComponentWalkDetails Class*/}
          ...
          <div className="hwpDailyNarrative">
            ...
            see
            <Link
              to="https://www.english-heritage.org.uk/visit/places/chesters-roman-fort-and-museum-hadrians-wall/"
              target="_blank"
            ...
            <br />
            <br />
            Turret 29A (Black Carts): Black Carts is a 200 metre section of
            ...
            <br />
            <br />
            Trig point at 250 metres: Following a climb of about 200 metres from
            Chollerford, the views now started to open up here. The Cheviot
            Hills came into view in the north and{" "}
            <Link
              to="https://www.chipchasecastle.com/"
              target="_blank"
              className="LinkHWP"
            >
              Chipchase Castle
            ...
            <br />
            <br />
            Limestone Corner: At Limestone Corner, there is an unfinished
            ...
            Corner, but this{" "}
            <Link
              to="https://perlineamvalli.wordpress.com/tag/limestone-corner/"
              target="_blank"
              className="LinkHWP"
            >
              {" "}
            ...
            with{" "}
            <Link
              to="https://www.english-heritage.org.uk/visit/places/chesters-roman-fort-and-museum-hadrians-wall/history/collection/"
              target="_blank"
              className="LinkHWP"
            >
              {" "}
            ...
            <br />
            <br />
            Join us on our 5th day of the Hadrian's Wall Path by clicking on the
            album below and following our narrative by clicking on the added
            comments.
          </div>{" "}
          {/*Closing tag for hwpDailyNarrative div */}
      ...
      <div className="datenewsDivHwp">
        <section className="newsheaderHwp">
          <strong>
            Day 6 - Brocolitia/Carrawburgh Roman Fort to Housesteads Roman Fort:
            5.7 miles on the Hadrian's Wall Path, 6.7 miles in total.
          </strong>
        </section>
        ...
        <div className="newsHwp">
          <div className="componentWalkDetails">
            ...
            <ul className="hwpIntroList">
              ...
              <li>
                <strong className="titles">Distance:</strong>
                <br /> 5.7 miles on the Hadrian's Wall Path, 6.7 miles in total.
                <strong> Ascent:</strong> 184 metres, 604 feet.{" "}
              </li>
              <li>
                <strong className="titles">Refreshments:</strong>
                <br />
            ...
            <ul className="hwpIntroList">
              ...
              <li>
                <strong className="titles">Cattle alert</strong>
                <br />
                ...
                cattle-filled fields so all was well.
              </li>
            </ul>
            <strong className="headTitles">Hike Rating</strong>
            <ul className="hwpIntroList">
          ...
          <div className="hwpDailyNarrative">
            ...
            wall, the{" "}
            <Link
              to="https://www.undiscoveredscotland.co.uk/hexham/templeofmithras/index.html"
              target="_blank"
            ...
            the field as{" "}
            <Link
              to="https://en.wikipedia.org/wiki/George_Wade"
              target="_blank"
            ...
            <br />
            <br />
            Join us on our 6th day of the Hadrian's Wall Path by clicking on the
            album below and following our narrative by clicking on the added
            comments.
          </div>{" "}
          {/*Closing tag for hwpDailyNarrative div */}
      ...
      <div className="datenewsDivHwp">
        <section className="newsheaderHwp">
          <strong>
            Day 7 - Housesteads Roman Fort to Cawfield Quarry (PS. This is the
            best day of the walk!): 6 miles on the Hadrian's Wall Path, 6.5
            miles in total.
          </strong>
        </section>
          ...
          <div className="componentWalkDetails">
            ...
            <ul className="hwpIntroList">
              <li>
                ...
                We parked at{" "}
                <Link
                  to="https://www.english-heritage.org.uk/visit/places/housesteads-roman-fort-hadrians-wall/plan-your-visit/facilities/"
                  target="_blank"
                ...
                and{" "}
                <Link
                  to="https://www.northumberlandnationalpark.org.uk/places-to-visit/hadrians-wall/cawfields/"
                  target="_blank"
                ...
                one of the cars.{" "}
                <Link
                  to="https://www.northumberlandnationalpark.org.uk/visitor-info/car-parks/"
                  target="_blank"
                  className="LinkHWP"
                >
                  {" "}
              ...
              <li>
                <strong className="titles">Distance:</strong>
                <br /> 6 miles on the Hadrian's Wall Path, 6.5 miles in total.
                <strong> Ascent:</strong> 309 metres, 1014 feet.{" "}
              </li>
              <li>
                <strong className="titles">Refreshments:</strong>
                <br />
            ...
            <ul className="hwpIntroList">
              <div className="listItemsAlign">
                <li>
                  <strong className="titles">Walk: </strong>This is without
                ...
                <li>
                  <strong className="titles">Path: </strong>
                  <br />
            ...
            <ul className="hwpIntroList">
              <li>
                <strong className="titles">
                  {" "}
                  Tragedy of the Sycamore Gap Tree:{" "}
                </strong>{" "}
                As many of you will know, on the morning of 28th September 2023,
                the iconic{" "}
                <Link
                  to="https://en.wikipedia.org/wiki/Sycamore_Gap_tree"
                  target="_blank"
              ...
              <li>
                <strong className="titles"> Weather warning: </strong>We were
            ...
            <ul className="hwpIntroList">
              <li>
                <strong className="titles">10 (out of 10):</strong>{" "}
              </li>
            </ul>
          </div>{" "}
          {/* Closing tag ComponentWalkDetails Class*/}
      ...
      <div className="datenewsDivHwp">
        <section className="newsheaderHwp">
          <strong>Day 8 - Cawfields Quarry to Gilsland: 6 miles.</strong>
        </section>
        ...
        <div className="newsHwp">
          <div className="componentWalkDetails">
            ...
            <ul className="hwpIntroList">
              ...
              <li>
                <strong className="titles">Paths: </strong>
                <br />A clear, well-defined path firstly through the ruins of
              ...
              <li>
                <strong className="titles">Distance:</strong>
                <br /> 6 miles on the Hadrian's Wall Path.
                <strong> Ascent:</strong> 325 metres, 1066 feet.{" "}
              </li>
              <li>
                <strong className="titles">Refreshments:</strong>
                <br />
            ...
            <ul className="hwpIntroList">
              <div className="listItemsAlign">
                <li>
                  ...
                  second to those of yesterday's walk.
                </li>
                <li>
                  <strong className="titles">History: </strong>
                  <br />
            ...
            <ul className="hwpIntroList">
              <li>
                <strong className="titles">
                  Path on the descents Walltown Crags:{" "}
                </strong>{" "}
                <br />
              ...
              <li>
                <strong className="titles">Aesica fort : </strong> <br />
          ...
          <div className="hwpDailyNarrative">
            ...
            found{" "}
            <Link
              to="https://perlineamvalli.wordpress.com/2015/10/17/the-best-bits-of-hadrians-wall-the-forts-great-chesters/"
              target="_blank"
              style={{ color: "blue" }}
            >
              {" "}
            ...
            and{" "}
            <Link
              to="https://www.u3ahadrianswall.co.uk/great-chester-roman-fortaesica/"
              target="_blank"
              style={{ color: "blue" }}
            >
              {" "}
            ...
            <Link
              to="https://en.wikipedia.org/wiki/Milecastle_45"
              target="_blank"
              style={{ color: "blue" }}
            >
              {" "}
            ...
            <Link
              to="https://www.gonortheast.co.uk/ad122"
              target="_blank"
              title="Click here to discover more 
            ...
            <Link
              to="https://www.northumberlandnationalpark.org.uk/places-to-visit/hadrians-wall/thirlwall-castle/"
              target="_blank"
      ...
      <div className="datenewsDivHwp">
        <section className="newsheaderHwp">
          <strong>
            Day 9 - Gilsland to Lanercost: 6.5 miles on the Hadrian's Wall Path,
            7.5 miles in total.
          </strong>
        </section>
        ...
        <div className="newsHwp">
          <div className="componentWalkDetails">
            ...
            <ul className="hwpIntroList">
              ...
              <li>
                ...
                <Link
                  to="https://www.facebook.com/houseofmegtearooms/?locale=en_GB"
                  target="_blank"
                  className="LinkHWP"
                >
                  House of Meg
                ...
                , or the{" "}
                <Link
                  to="https://www.facebook.com/bridgeinngilsland/?locale=en_GB"
                  target="_blank"
                  className="LinkHWP"
                >
                  {" "}
              ...
              <li>
                <strong className="titles">Distance:</strong>
                <br /> 6.5 miles on the Hadrian's Wall Path, 7.5 miles in total
                <strong> Ascent:</strong> 191 metres, 623 feet.{" "}
              </li>
              <li>
                <strong className="titles">Refreshments:</strong>
                <br /> The{" "}
            ...
            <ul className="hwpIntroList">
              <div className="listItemsAlign">
                ...
                <li>
                  <strong className="titles">Countryside :</strong>
                  <br />
            ...
            <ul className="hwpIntroList">
              <li>
                <strong className="titles">Summer holiday season</strong>
                <br />
            ...
            <ul className="hwpIntroList">
              <li>
                <strong className="titles">10 (out of 10):</strong> This was a
                far more enjoyable and interesting section of the wall than we
          ...
          <div className="hwpDailyNarrative">
            ...
            from{" "}
            <Link
              to="https://www.visitcumbria.com/car/gilsland/"
              target="_blank"
            ...
            , via{" "}
            <Link
              to="https://www.english-heritage.org.uk/visit/places/birdoswald-roman-fort-hadrians-wall/"
              target="_blank"
            ...
            , over to{" "}
            <Link
              to="https://www.english-heritage.org.uk/visit/places/lanercost-priory/"
              target="_blank"
            ...
            <br />
            <Link
              to="https://www.english-heritage.org.uk/visit/places/poltross-burn-milecastle-hadrians-wall/history/"
              target="_blank"
              title="Click here to discover more about 
            ...
            <br />
            <Link
              to="https://www.english-heritage.org.uk/visit/places/willowford-wall-turrets-and-bridge-hadrians-wall/history/"
              target="_blank"
            ...
            <br />
            <Link
              to="https://www.english-heritage.org.uk/visit/places/harrows-scar-milecastle-and-wall-hadrians-wall/history/"
              target="_blank"
            ...
            found{" "}
            <Link
              to="https://en.wikipedia.org/wiki/Milecastle_49"
              target="_blank"
            ...
            <br />
            <Link
              to="https://www.english-heritage.org.uk/visit/places/birdoswald-roman-fort-hadrians-wall/history-and-stories/history/"
              target="_blank"
            ...
            <br />
            <Link
              to="https://hadrianswallcountry.co.uk/attraction/leahill-turret-and-piper-sike-turret/"
              target="_blank"
              className="LinkHWP"
            >
              {" "}
            ...
            <br />
            <Link
              to="https://en.wikipedia.org/wiki/Pike_Hill_Signal_Tower"
              target="_blank"
              className="LinkHWP"
            >
              {" "}
            ...
            <br />
            <Link
              to="https://en.wikipedia.org/wiki/Milecastle_52"
              target="_blank"
            ...
            <br />
            <Link
              to="https://www.english-heritage.org.uk/visit/places/hare-hill-hadrians-wall/"
              target="_blank"
              className="LinkHWP"
            >
              {" "}
            ...
            <br />
            <br />
            Join us on our 9th day of the Hadrian's Wall Path by clicking on the
            album below and following our narrative by clicking on the added
            comments.
          </div>{" "}
          {/*Closing tag for hwpDailyNarrative div */}
      ...
      <div className="datenewsDivHwp">
        <section className="newsheaderHwp">
          <strong>
            Day 10 - Lanercost to Low Crosby village: 8.75 miles on the
            Hadrian's Wall Path, 9.75 miles in total.
          </strong>
        </section>
        ...
        <div className="newsHwp">
          <div className="componentWalkDetails">
            ...
            <ul className="hwpIntroList">
              ...
              <li>
                <strong className="titles">Paths: </strong>
                <br /> As for all the Hadrian's Wall national trail, the path is
              ...
              <li>
                <strong className="titles">Distance:</strong>
                <br /> 8.75 miles on the Hadrian's Wall Path, 9.75 miles in
              ...
              <li>
                ...
                <br />{" "}
                <Link
                  to="https://www.waltoncumbria.uk/tearoom/index.htm"
                  target="_blank"
                  title="Click here to look at the opening times and sample menu for Walton Tearoom"
                  className="LinkHWP"
                >
                  Walton Tearoom{" "}
                </Link>{" "}
            ...
            <ul className="hwpIntroList">
              <div className="listItemsAlign">
                ...
                <li>
                  ...
                  is definitely worth a visit and the proprietors are very
                  welcoming. It is open 10.00-17.00 every day. The picnic bench
            ...
            <ul className="hwpIntroList">
              ...
              <li>
                <strong className="titles">
                  Remaining segments of the wall :
                </strong>
                <br />
            ...
            <ul className="hwpIntroList">
              <li>
                <strong className="titles">9 (out of 10):</strong> An enjoyable
                days walking through lovely countryside and with some
                spectacular views.
              </li>
            </ul>
          </div>{" "}
          ...
          <div className="hwpDailyNarrative">
            ...
            <Link
              to="https://www.visitcumbria.com/car/walton/"
              target="_blank"
              title="Click here to discover 
            more about Walton village, St Mary's church and Walton Tearoom, North Cumbria"
              className="LinkHWP"
            >
              {" "}
              Walton village and St Mary's church{" "}
            </Link>{" "}
            are on the path of Hadrian's Wall. Walton is only a small village
            but is very pretty with some great views out towards Cold Fell and
            the North Pennines and has one very important feature for all
            walkers on the Hadrian's Wall path, the{" "}
            <Link
              to="https://www.waltoncumbria.uk/tearoom/index.htm"
              target="_blank"
              title="Click here to look at the opening times and sample menu for Walton Tearoom"
            ...
            . This is open from 10.00-17.00 daily and is{" "}
            <Link
              to="https://www.tripadvisor.co.uk/ShowUserReviews-g8715454-d8155353-r941402870-The_Reading_Room_at_Walton-Walton_Brampton_Cumbria_England.html"
              target="_blank"
              className="LinkHWP"
            >
              very popular{" "}
            </Link>{" "}
            with Hadrian's Wall walkers.
            <br />
            <br />
            <strong style={{ fontSize: "rem1.2" }}>
              {" "}
            ...
            <Link
              to="https://perlineamvalli.wordpress.com/tag/castlesteads/"
              target="_blank"
            ...
            <Link
              to="https://www.u3ahadrianswall.co.uk/castlesteads-roman-fort-camboglanna/"
              target="_blank"
              className="LinkHWP"
            ...
            <br />
            <br />
            <strong style={{ fontSize: "rem1.2" }}> Bleatarn Farm: </strong> The
            ...
            <br />
            <br />
            Join us on our 10th day of the Hadrian's Wall Path by clicking on
            the album below and following our narrative by clicking on the added
            comments.
          </div>{" "}
          {/*Closing tag for hwpDailyNarrative div */}
          <br />
      ...
      <div className="datenewsDivHwp">
        <section className="newsheaderHwp">
          <strong>
            Day 11 - Low Crosby village to Burgh-by-Sands: 11.8 miles.
          </strong>
        </section>
        ...
        <div className="newsHwp">
          <div className="componentWalkDetails">
            ...
            <ul className="hwpIntroList">
              ...
              <li>
                <strong className="titles">Distance:</strong>
                <br /> 11.8 miles <strong> Ascent:</strong> approx 80 metres,
                approx 262 feet.{" "}
              </li>
              <li>
                <strong className="titles">Refreshments:</strong>
                <br /> TG café Bitt's Park, Carlisle and the Greyhound Inn
                Burgh-by-Sands{" "}
              </li>{" "}
            </ul>
            ...
            <ul className="hwpIntroList">
              <div className="listItemsAlign">
                <li>
                  <strong className="titles">History : </strong>
                  <br /> Whilst there are no visible remains of Hadrian Wall to
                ...
                <li>
                  <strong className="titles">Walk :</strong>
                  <br /> Whilst lengthy, this was an easier walk than many of
                ...
                <li>
                  <strong className="titles">Refreshments : </strong>
                  <br /> There was plenty of opportunity for refreshments. We
                ...
                <li>
                  <strong className="titles">Weather: </strong>
                  <br /> It did not rain....what more can I say? That is all
                  that matters.
                </li>
              </div>
            </ul>
            ...
            <ul className="hwpIntroList">
              <li>
                <strong className="titles">Time Available :</strong>
                <br />
            ...
            <ul className="hwpIntroList">
              <li>
                <strong className="titles">8 (out of 10):</strong> An enjoyable
                days walking which, despite the length, did not seem too
                challenging.
              </li>
            </ul>
          </div>{" "}
          ...
          <div className="hwpDailyNarrative">
            ...
            <br />
            <br />
            <strong style={{ fontSize: "rem1.2" }}> River Eden: </strong> The
            ...
            <br />
            <br />
            <strong style={{ fontSize: "rem1.2" }}> Carlisle: </strong> There is
            ...
            <br />
            <br />
            <strong style={{ fontSize: "rem1.2" }}> Burgh-by-Sands: </strong> St
            ...
            <br />
            <br />
            Join us on our 11th day of the Hadrian's Wall Path by clicking on
            the album below and following our narrative by clicking on the added
            comments.
          </div>{" "}
          {/*Closing tag for hwpDailyNarrative div */}
      ...
      <div className="datenewsDivHwp">
        <section className="newsheaderHwp">
          <strong>
            Day 12 - Burgh-by-Sands to Bowness-on-Solway. THE FINAL DAY OF THE
            HADRIAN'S WALL PATH!: 8.5 miles.
          </strong>
        </section>
        <section className="dateHwp">24th August 2024, Saturday</section>
        <div className="newsHwp">
          <div className="componentWalkDetails">
            <strong className="headTitles">Details of the Walk </strong>
            <br />
            ...
            <ul className="hwpIntroList">
              ...
              <li>
                <strong className="titles">Paths: </strong>
                <br /> The path for today's walk runs along the road (which is
              ...
              <li>
                <strong className="titles">Distance:</strong>
                <br /> 11.8 miles <strong> Ascent:</strong> approx 20 metres,
                approx 33 feet.{" "}
              </li>
              <li>
                <strong className="titles">Refreshments:</strong>
                <br /> Solway Lounge and Garrison Bistro and the Kings Arms
                (both in Bowness-on-Solway) followed by the Drover's Rest at
                Monkhill for our final end of trail celebratory meal.{" "}
              </li>
              <br />
              <br />
            </ul>
            ...
            <ul className="hwpIntroList">
              <div className="listItemsAlign">
                <li>
                  <strong className="titles"> Final Day: </strong>
                  <br /> It was THE FINAL DAY OF THE HADRIAN'S WALL PATH - what
                  more can I say?
                </li>
                <br />
                <br />
                <li>
                  <strong className="titles">
                    Landscape of the Solway Firth :
                  </strong>
                  <br /> The landscape of the Solway Firth has that sense of
                ...
                <li>
                  <strong className="titles">Refreshments : </strong>
                  <br /> Solway Lounge and Garrison Bistro for refreshments
                  before we started the walk and the Kings Arms for drinks at
                  the end (both in Bowness-on-Solway). Our first opportunity to
                  try out the{" "}
                  <Link
                    to="https://www.droversrestinn.com/"
                    target="_blank"
                ...
                <li>
                  <strong className="titles">Weather: </strong>
                  <br /> The forecast had been for some not great weather, but
                ...
                <li>
                  <strong className="titles">Seating: </strong>
                  <br /> A distinct positive on this section of the walk was
                ...
                <li>
                  <strong className="titles">History: </strong>
                  <br /> Burgh-by-Sands, Drumburgh Castle and Bowness-on-Solway
            ...
            <ul className="hwpIntroList">
              <li>
                <strong className="titles">Road-walking :</strong>
                <br />
              ...
              <li>
                <strong className="titles">Final day: </strong>
                <br /> It was a sad occasion too, as our trek was coming to and
            ...
            <ul className="hwpIntroList">
              <li>
                <strong className="titles">8 (out of 10):</strong> The final day
          ...
          <div className="hwpDailyNarrative">
            ...
            <br />
            <br />
            <strong style={{ fontSize: "rem1.2" }}> Burgh-by-Sands: </strong> is
            ...
            <br />
            <br />
            <strong style={{ fontSize: "rem1.2" }}> Drumburgh: </strong>{" "}
            ...
            <br />
            <br />
            <strong style={{ fontSize: "rem1.2" }}>Views :</strong> to the South
            ...
            <br />
            <br />
            <strong style={{ fontSize: "rem1.2" }}> Port Carlisle: </strong>A
            BBC TV programme last year,{" "}
            <em>
              (for those of you who have an up to date BBC UK TV licence only!)
            </em>{" "}
            currently available on{" "}
            <Link
              to="https://www.bbc.co.uk/iplayer/episode/m001s1y5/villages-by-the-sea-series-4-2-port-carlisle"
              target="_blank"
            ...
            <Link
              to="https://solwayshorewalker.co.uk/2018/10/13/port-carlisle-canals-and-ships-and-trains/"
              target="_blank"
              title="Click here to discover more.."
              className="LinkHWP"
            >
            ...
            <Link
              to="https://www.amazon.co.uk/Fresh-Salt-Story-Solway/dp/1780276931/ref=sr_1_1?crid=1V7OLFGZ4S6IV&keywords=the+fresh+and+the+salt&qid=1700393297&sprefix=the+fresh+and+the+salt%2Caps%2C184&sr=8-1"
              target="_blank"
            ...
            <br />
            <br />
            Join us on our 12th day of the Hadrian's Wall Path by clicking on
            the album below and following our narrative by clicking on the added
            comments.
          </div>{" "}
          {/*Closing tag for hwpDailyNarrative div */}
      ...
      <div className="datenewsDivHwp">
        <section className="newsheaderHwp">
          <strong>
            ADDITIONAL DAY - Visit to the Roman Army Museum and Vindolanda{" "}
          </strong>
        </section>
        ...
        <div className="newsHwp">
          <div className="componentWalkDetails">
            <div className="hwpDailyNarrative">
              ...
              poor, wet weather. So rather than undertaking another stage of our
              Hadrian's Wall walk on the Sunday, given it was forecast for rain
              again, we decided it was time for a catch-up day in which we would
              take the opportunity to visit the Roman Army Museum and Vindolanda
              in a relaxed fashion.
              <br />
              <br />
              The Roman Army Museum: We have visited Vindolanda previously, but
              not the Roman Army Museum and so had long planned a visit. We
              commenced the visit by watching the Edge of Empire The Eagle's Eye
              ...
              talking about the making of the Edge of Empire The Eagle's Eye
              film which can be found on You Tube videos. It is a really
      ...
      <div className="datenewsDivHwp">
        <section className="newsheaderHwp">
          <strong>
            ADDITIONAL DAY - Visit to the Hadrian's Wall Gallery at the Great
          ...
          <div className="blogPhotoDivHwp">
            <figure>
              <section className="blogPhoto">
                <img
                  src={GreatNorthern}
                  alt=""
                  style={{ border: "solid 4px #D5544F" }}
                />
                <figcaption className="augustfigcaption">
                  <strong>
                    The Great North Museum, <br /> Newcastle upon Tyne
                  </strong>
                </figcaption>
              </section>
            </figure>
            <figure>
              <section className="blogPhoto">
                ...
                />
                <figcaption className="augustfigcaption">
                  <strong></strong>One of the impressive displays at the <br />{" "}
                  museum, taking us on a drone's-eye view of <br /> the
            ...
            <figure>
              <section className="blogPhoto">
                ...
                <figcaption className="augustfigcaption">
                  <strong>
                    Altar dedicated to Mithras by <br /> Pubicius Proculinus and
                    his son <br /> Proculus, Housesteads Mithraeum <br /> 1822{" "}
                  </strong>
                </figcaption>
              </section>
            </figure>
            <figure>
              <section className="blogPhoto">
                ...
                <figcaption className="augustfigcaption">
                  <strong>
                    Tombstone of Aurelia Aureliana, <br />
                    set up for her by her husband Ulpius <br /> Apolinaris, mid
                    3rd century AD, found in the Roman cemetery on Gallows Hill,
                    Carlisle
                  </strong>
                </figcaption>
              </section>
      ...
      <div className="datenewsDivHwp">
        <section className="newsheaderHwp">
          <strong>
            ADDITIONAL DAY - VISIT TO THE SYCAMORE GAP EXHIBITION AT THE SILL
          </strong>
        </section>
        ...
        <div className="newsHwp">
          <div className="componentWalkDetails">
            <div className="hwpDailyNarrative">
              ...
              the 3rd November 2024. The Guardian newspaper recently published
      ...
      <div className="datenewsDivHwp">
        ...
        <div className="newsHwp">
          <div className="componentWalkDetails">
            <div className="hwpDailyNarrative">
              When we walked the Birdowswald Fort section of Hadrian's Wall on
              the 28th July 2024, there was not time to call in and explore the
              fort more fully, so we promised that sometime over the quieter
              Winter months we would pay Birdoswald Fort a visit, especially as
              Harry had never had the opportunity to visit.
              <br />
              <br />
              ...
              carefully. It is an interesting fort and well worth a visit if you
              are in the area! It is probably worthwhile obtaining a copy of the
              English Heritage guidebook though as it contains some additional
        ...
        <div className="blogPhotoDivHwp">
          <figure>
            <section className="blogPhoto">
              ...
              <figcaption className="augustfigcaption">
                <strong>
                  Birdoswald Farmhouse, <br /> which stands on the site <br />{" "}
                  of the old Roman Fort Banna.
                </strong>
              </figcaption>
            </section>
          </figure>
          <figure>
            <section className="blogPhoto">
              ...
              <figcaption className="augustfigcaption">
                <strong>
                  We are standing here <br /> on the Via Principalis, <br />{" "}
                  about to enter what <br /> was the West Gate.
                </strong>
              </figcaption>
            </section>
          </figure>
          <figure>
            <section className="blogPhoto">
              ...
              <figcaption className="augustfigcaption">
                <strong>
                  There are helpful information <br /> boards, this one
                  concerning <br /> the West Gate.
                </strong>
              </figcaption>
            </section>
          </figure>
          <figure>
            <section className="blogPhoto">
              ...
              <figcaption className="augustfigcaption">
                <strong>
                  This English Heritage guidebook <br /> about the fort is worth{" "}
                  <br /> purchasing as it provides <br /> more detailed
                  information.
                </strong>
              </figcaption>
            </section>
