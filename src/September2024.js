  ...
  return (
    <div style={{ backgroundColor: "#504F22" }}>
      ...
      <div className="datenewsDivSeptember" style={{ marginTop: "5%" }}>
        <section className="newsheaderSeptember">
        ...
        <section className="newsSeptember" style={{ textAlign: "center" }}>
          ...
          their calves, which has meant for some cautious maneuvering through
      ...
      {/* Closing tag datenewsDivSeptember */}
      <div className="datenewsDivSeptember">
        <section className="dateSeptember">3rd September 2024</section>
        <section className="newsheaderSeptember">
          {" "}
          Visit to Sir Walter Scott's House, Abbotsford
        </section>
        <br />
        <section className="newsSeptember">
          {" "}
          <strong>
            Who was Sir Walter Scott: <br />{" "}
          </strong>{" "}
          <Link
            to="https://en.wikipedia.org/wiki/Walter_Scott"
            target="_blank"
            title="Click here to discover more about Sir Walter Scott"
            className="LinkSeptember"
          >
            <strong> Sir Walter Scott </strong>{" "}
          </Link>{" "}
          ...
          notably the novels{" "}
          <Link
            to="https://www.goodreads.com/book/show/6440.Ivanhoe"
            target="_blank"
            className="LinkSeptember"
          >
            Ivanhoe (1819){" "}
          ...
          ,{" "}
          <Link
            to="https://www.goodreads.com/book/show/543686.Rob_Roy"
            target="_blank"
            className="LinkSeptember"
          >
            {" "}
          ...
          ,{" "}
          <Link
            to="https://www.goodreads.com/book/show/539025.Waverley"
            target="_blank"
            className="LinkSeptember"
          >
            {" "}
          ...
          ,
          <Link
            to="https://www.goodreads.com/book/show/699603.Old_Mortality"
            target="_blank"
            className="LinkSeptember"
          >
            {" "}
          ...
          ,
          <Link
            to="https://www.goodreads.com/book/show/699484.The_Heart_of_Mid_Lothian"
            target="_blank"
            className="LinkSeptember"
          >
            {" "}
          ...
          , and{" "}
          <Link
            to="https://www.goodreads.com/book/show/49495.The_Bride_of_Lammermoor"
            target="_blank"
            className="LinkSeptember"
          >
            {" "}
          ...
          <Link
            to="http://www.walterscott.lib.ed.ac.uk/works/poetry/marmion.html"
            target="_blank"
            className="LinkSeptember"
          >
            {" "}
          ...
          and
          <Link
            to="http://www.walterscott.lib.ed.ac.uk/works/poetry/lady.html"
            target="_blank"
            className="LinkSeptember"
          >
            {" "}
              ...
              <section className="blogPhotoSeptember">
                ...
                <figcaption className="augustFigCaption">
                  <strong>
                    ...
                    these items are of historical interest....
                  </strong>
                </figcaption>
              </section>
            </figure>
      ...
      <div className="datenewsDivSeptember">
        ...
        <section className="newsheaderSeptember">
          {" "}
          ADDITIONAL DAY - Visit to the Great North Museum, Newcastle upon Tyne
        </section>
        <br />
        <section className="newsSeptember" style={{ textAlign: "center" }}>
          Today, we took the opportunity to take the train into Newcastle upon
          ...
          at our
          <Link to="/hwp2024" className="LinkSeptember">
            {" "}
      ...
      <div className="datenewsDivSeptember">
        ...
        <section className="newsheaderSeptember">
          <strong>Dodd Summit, Wood and Mirehouse, Bassenthwaite</strong>
        </section>
        <div className="newsSeptember">
          <div className="componentWalkDetailsSeptember">
            <strong className="headTitlesSeptember">
              Details of the Walk{" "}
            </strong>
            <ul className="hwpIntroList">
              ...
              <li>
                <strong className="titlesSeptember">Paths: </strong>
                <br /> The paths are clear, well-maintained and well-signposted.{" "}
              </li>
              <li>
                <strong className="titlesSeptember">Distance:</strong>
                <br /> 7.2 miles in total <strong> Ascent:</strong> 530 metres,
                1,740 feet.{" "}
              </li>
              <li>
                <strong className="titlesSeptember">Refreshments:</strong>{" "}
                <Link
                  to="https://www.mirehouse.co.uk/plan-your-visit/the-old-sawmill-tearoom/"
                  target="_blank"
            ...
            <ul className="hwpIntroList">
              <div className="listItemsAlign">
                <li>
                  <strong className="titlesSeptember">Walk :</strong>
                  <br /> Really enjoyable walk with over 500 metres in ascent so
                ...
                <br />
                <li>
                  <strong className="titlesSeptember">
                    Mirehouse Gardens :
                  </strong>
                  <br />{" "}
                  <Link
                ...
                <br />
                <li>
                  <strong className="titlesSeptember">Weather: </strong>
                  <br />
            ...
            <ul className="hwpIntroList">
              <li>
                <strong className="titlesSeptember">Moderately busy :</strong>
                <br />
            ...
            <ul className="hwpIntroList">
              <li>
                <strong className="titlesSeptember">9.5 (out of 10):</strong> An
                enjoyable days walking and climbing in a beautiful location with
          ...
          <div className="SeptemberDailyNarrative">
            ...
            <div className="slideshowHostPhotoSeptember">
              <figure>
                ...
                >
                  <img
                    className="slideshowentrySeptember"
      ...
      <div className="datenewsDivSeptember">
        ...
        <section className="newsheaderSeptember">
          <strong>
            Ascent up to the boggy, treacherous summit of Cold Fell, Geltsdale
            and beyond.
          </strong>
        </section>
        <div className="newsSeptember">
          <div className="componentWalkDetailsSeptember">
            ...
            <ul className="hwpIntroList">
              ...
              <li>
                <strong className="titlesSeptember">Paths:</strong>
                <br /> There is a 70% discernible path on the ascent, which
              ...
              <li>
                <strong className="titlesSeptember">Distance:</strong>
                <br /> 6.6 miles in total <strong> Ascent:</strong> 621 metres,
                2,037 feet.{" "}
              </li>
              <br />
              <br />
              <li>
                <strong className="titlesSeptember">Refreshments:</strong>
                <br /> If you are down in time, refreshments are available at
            ...
            <ul className="hwpIntroList">
              <div className="listItemsAlign">
                <li>
                  <strong className="titlesSeptember">
                    Spectacular and far-reaching views :
                  </strong>
                  <br /> This climb, albeit very tough underfoot with paths
                ...
                <li>
                  ...
                  <Link
                    to="https://www.bookscumbria.com/product/uk-books/countryside-and-nature/tindale/"
                    target="_blank"
            ...
            <ul className="hwpIntroList">
              <li>
                <strong className="titlesSeptember">
                  Lack of clear paths, particularly on the descent :
                </strong>
                <br /> Initially on leaving the summit, the path remains clear
              ...
              <br />
              <li>
                <strong className="titlesSeptember">Terrains :</strong>
                <br /> It is very hard going underfoot. There are some very
            ...
            <ul className="hwpIntroList">
              <li>
                <strong className="titlesSeptember">6 (out of 10):</strong>
                <br />
          ...
          <div className="SeptemberDailyNarrative">
            ...
            <Link
              to="https://northpennines.org.uk/location/cold-fell-walk/"
              target="_blank"
            ...
            <br />
            <br />
            Join us on our day out to Cold Fell by clicking on the album below
            and following our narrative by clicking on the added comments.
            <br />
            <br />
            <div className="slideshowHostPhotoSeptember">
              <figure>
      ...
      <div className="datenewsDivSeptember">
        ...
        <section className="newsheaderSeptember">
          <strong>Walk Croglin and Newbiggin, 5 miles</strong>
        </section>
        <div className="newsSeptember">
          <div className="componentWalkDetailsSeptember">
            <strong className="headTitlesSeptember">
            ...
            <ul className="hwpIntroList">
              ...
              <li>
                <strong className="titlesSeptember">Paths:</strong>
                <br /> This is a walk along well-established bridleways and
              ...
              <li>
                <strong className="titlesSeptember">Distance:</strong>
                <br /> 5 miles in total <strong>, Ascent:</strong> 220 metres,
                720 feet.{" "}
              </li>
              <br />
              <br />
            ...
            <ul className="hwpIntroList">
              <div className="listItemsAlign">
                <li>
                  ...
                  <br /> There are some particularly spectacular views of the
                ...
                <li>
                  ...
                  <br /> This area is always beautifully peaceful, perhaps
            ...
            <ul className="hwpIntroList">
              <li>
                <strong className="titlesSeptember">10 (out of 10):</strong>
                <br />
              </li>
            </ul>
          </div>{" "}
          ...
          <div className="SeptemberDailyNarrative">
            ...
            <Link
              to="https://www.bookscumbria.com/product/cumbrian-books/cumbrian-outdoors/walking/hadrians-wall-the-borders/walking-in-cumbria-s-eden-valley/"
              target="_blank"
              style={{ color: "#D23736" }}
            >
      ...
      <div className="datenewsDivSeptember">
        ...
        <section className="newsheaderSeptember">
          <strong>Walk Great Ashby Scar and Orton, 10 miles</strong>
        </section>
        <div className="newsSeptember">
          <div className="componentWalkDetailsSeptember">
            <strong className="headTitlesSeptember">
            ...
            <ul className="hwpIntroList">
              ...
              <li>
                <strong className="titlesSeptember">Paths:</strong>
                <br /> The route is on bridleways on open limestone moorland and
                tracks. It includes a 1.5km section on the{" "}
                <Link
                  to="https://www.coasttocoast.uk/"
                  target="_blank"
                  style={{ color: "#D23736" }}
                >
                  Coast to Coast Path
                ...
                for presents at the{" "}
                <Link
                  to="https://www.kennedyschocolates.co.uk/orton-chocolate-shop/"
                  target="_blank"
                  style={{ color: "#D23736" }}
                >
                  chocolate factory
              ...
              <li>
                <strong className="titlesSeptember">Distance:</strong>
                <br /> Just under 10 miles in total <strong>
                  , Ascent:
                </strong>{" "}
            ...
            <ul className="hwpIntroList">
              <li>
                <strong className="titlesSeptember">8.5 (out of 10):</strong>
                <br />
          ...
          <div className="SeptemberDailyNarrative">
            ...
            feet) with{" "}
            <Link
              to="https://en.wikipedia.org/wiki/Castle_Folds"
              target="_blank"
