    ...
    <div>
      ...
      <div className="mainDecember">
        ...
        <section className="newsDecember" style={{ textAlign: "left" }}>
          ...
          <Link
            to="https://www.rhs.org.uk/gardens/hyde-hall"
            target="_blank"
        ...
        <div className="SlideshowHostPhotoDecember">
          <Link
            to="https://photos.app.goo.gl/j4Xmhghp8sc9uLKb9"
            target="_blank"
        ...
        <div className="SlideshowHostPhotoDecember">
          <Link
            to="https://photos.app.goo.gl/BSWeChYShX1Axteo7"
            target="_blank"
        ...
        <div className="SlideshowHostPhotoDecember">
          <Link
            to="https://photos.app.goo.gl/U3EsSzVtSeFFzWdM8"
            target="_blank"
