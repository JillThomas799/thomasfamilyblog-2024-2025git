    ...
    <div className="bodyCdS">
      ...
      >
        ...
        <div className="datenewsDivCdS">
          ...
          {/*Closing tab for newsCdS div */}
        </div>{" "}
        {/*Closing tab for datenewsDivCdS div */}
        <div className="SlideshowHostPhotoCdS">
          <div className="slideshowinstructionsCdS">
            {" "}
            <strong>
              Click on the image below to open the album of our walking <br />{" "}
              the Ainhoa segment of the Camino del Norte in the French Basque{" "}
              <br /> country many years ago back in 2011. Here is a link to an
              article on this walk <br />{" "}
              <Link
                to="https://www.guide-du-paysbasque.com/en/experiences/sport/article-ainhoa-hawthorn-chapel-hike-252.html"
                target="_blank"
                className="LinkCdS"
              >
                {" "}
                Ainhoa : randonnée de la Chapelle <br /> de l’Aubépine
              </Link>
            </strong>
            <br /> <br />
            <Link
              to="https://photos.app.goo.gl/vGooB6M5u9NNBtZQA"
              target="_blank"
              className="LinkCdS"
            >
              <img
                className="slideshowentryCdS"
                src={CaminoDelNorte2011Titled}
                alt=""
              />
            </Link>
          </div>{" "}
          {/*Closing div slideshowinstructionsCdS*/}
        </div>
        <div className="datenewsDivCdS">
          <section className="newsheaderCdS">
            <strong>A Brief History of the Camino de Santiago</strong>
          </section>
          ...
          <div className="newsCdS">
            <div className="CdSDailyNarrative">
              The{" "}
              <Link
                to="https://en.wikipedia.org/wiki/Santiago_de_Compostela"
                target="_blank"
                className="LinkCdS"
              >
                Wikipedia page{" "}
            ...
            {/*Closing tag for CdSDailyNarrative div */}
          </div>
        </div>
      </h1>
    </div>
